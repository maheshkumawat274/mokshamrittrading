  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        <div className="absolute top-[20%] left-[8%] w-80 h-80 bg-slate-200/40 rounded-full blur-3xl pointer-events-none"></div>
        <div className="absolute bottom-[20%] right-[12%] w-80 h-80 bg-slate-300/20 rounded-full blur-3xl pointer-events-none"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-center lg:text-left">
        <div className="max-w-3xl space-y-4">
          ...
          <p className="text-slate-600 text-sm leading-relaxed max-w-2xl font-sans font-light mx-auto lg:mx-0">
            Direct communications regarding spot FOB trades, high-density metal machinery specs, fabric test packs, agricultural grades samples, or multi-port container freight bookings.
          </p>
        </div>
      </div>
    </section>
